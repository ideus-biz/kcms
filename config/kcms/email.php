...
return [
	...
	'profiles' => [
		'default' => [
			/**
			 * Базовое имя класса-отправителя писем eMail_Sender_Laravel.
			 */
			'sender' => 'Laravel',
			'config' => [],
		],
		...
		'mail' => [
			/**
			 * Базовое имя класса-отправителя писем eMail_Sender_Mail.
			 * 
			 * Простой отправитель писем, использующий системную функцию mail() в самом простом варианте.
			 */
			'sender' => 'Mail',
			'config' => [],
		],
